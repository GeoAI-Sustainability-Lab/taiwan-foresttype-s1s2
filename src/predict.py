...
INPUT.csv must contain the 34 feature columns listed in models/rf_full_meta.json
(same names and order as data/features_train4yr.csv; exported by gee/05_feature_exporter_34.js).
Writes the predicted class (1=Broadleaf, 2=Conifer, 3=Bamboo), the class name,
and per-class probabilities. With no argument it demos on data/features_test1yr_2025-2026.csv.
"""
...
inp  = sys.argv[1] if len(sys.argv) > 1 else os.path.join(HERE, "data", "features_test1yr_2025-2026.csv")
