...
| `fig3_phenology_fit.py` | first-order harmonic fit of the NDMI and VH series of one representative stand per class (`data/analyses/fig3_ts_points.csv`) and the panels (a, b) of Fig. 3, composited with the unchanged chips `figures/fig3_chips.png` | `fig3_fit.json`, `figures/fig3_phenology.png` |
